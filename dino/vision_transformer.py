...
class PatchEmbed(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, embed_dim=768):
        ...
        ### Mingyuan
        #self.proj = nn.Conv2d(in_chans, embed_dim, kernel_size=patch_size, stride=patch_size//2, padding=(4,4), padding_mode='reflect')
...
class VisionTransformer(nn.Module):
    ...
    def interpolate_pos_encoding(self, x, w, h):
        ...
        #w0 = int(w // self.patch_embed.patch_size *2)
        #h0 = int(h // self.patch_embed.patch_size *2)
